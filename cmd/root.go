...
var rootCmd = &cobra.Command{
	Use:   "task",
	Short: "Task is a TODO application",
	Long: `Task will help you get track of your tasks and todo items. It's designed
to be as simple as possible to help you.`,
